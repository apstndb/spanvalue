module github.com/apstndb/spanvalue/integration/pgtypeannotation
...
// Resolve the parent module to the checkout root (monorepo). CI and local clones
// use the same replace; published consumers use the normal module path from the registry.
